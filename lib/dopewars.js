...
function initEvents() {
    // Frequency, Message, ???, Event Multiplier (e.g. Event multiplies weed price * 4), Event divider (e.g. Weed price / 4), Extra drugs
    ...
    events = [
        ...
        [13, "The cops just did a big Ecstacy bust!  Prices are sky-high!", 2, 4, 0, 0],
